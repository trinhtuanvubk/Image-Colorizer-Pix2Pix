...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default="/home/aittgp/vutt/workspace/patch_planet/Image-Colorizer-Pix2Pix/own_miss_data/AB", help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--name', type=str, default='miss_pix2pix', help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--gpu_ids', type=str, default='-1', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--checkpoints_dir', type=str, default='/home/aittgp/vutt/workspace/patch_planet/Image-Colorizer-Pix2Pix/checkpoints', help='models are saved here')
        # model parameters
